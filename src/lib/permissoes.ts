...
export const GRUPOS_ADMIN: GrupoAdmin[] = [
  ...
  { id: "operacoes", label: "Operações & Obras", itens: [
    ...
    { key: "obras-diario", label: "Diário de Obra", icon: "📔", href: "/admin/obras/diario" },
  ...
  { id: "negocios", label: "Novos Negócios", itens: [
    ...
    { key: "negocios-investidores", label: "Investidores", icon: "💼", href: "/admin/negocios/investidores" },
  ] },
  ...
  { id: "juridico", label: "Jurídico & Documentos", itens: [
    ...
    { key: "doc-bancarios", label: "Documentos Bancários", icon: "🏦", href: "/admin/doc-bancarios" },
    { key: "doc-seguros", label: "Seguros", icon: "🛡️", href: "/admin/doc-empresa?view=seguros" },
...
export function moduloDaRotaApi(pathname: string): string | null {
  ...
  if (seg === "doc-empresa") {
    ...
    const sub = (rest.split("/")[0] || "").replace(/\.ts$/, "");
    if (["extratos", "faturas", "emprestimos", "bancarios-email", "bancarios-whatsapp"].includes(sub)) return "doc-bancarios";
    return "doc-empresa";
  }
