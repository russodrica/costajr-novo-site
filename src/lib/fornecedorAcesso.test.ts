...
const soItau: AcessoFornecedor = { docEmpresa: false, docBancarios: true, bancosModo: "lista", bancos: ["Itaú"], faturas: false, emprestimos: false };
...
const todos: AcessoFornecedor = { docEmpresa: true, docBancarios: true, bancosModo: "todos", bancos: [], faturas: false, emprestimos: false };
t("qualquer banco passa", bancoLiberado(todos, "Sicoob"), true);
t("banco novo (futuro) passa", bancoLiberado(todos, "Banco XPTO"), true);
const semBanc: AcessoFornecedor = { docEmpresa: true, docBancarios: false, bancosModo: "todos", bancos: [], faturas: false, emprestimos: false };
t("módulo desligado bloqueia mesmo com modo 'todos'", bancoLiberado(semBanc, "Itaú"), false);
const listaVazia: AcessoFornecedor = { docEmpresa: false, docBancarios: true, bancosModo: "lista", bancos: [], faturas: false, emprestimos: false };
...
t("resumo vazio", resumoAcesso({ docEmpresa: false, docBancarios: false, bancosModo: "lista", bancos: [], faturas: false, emprestimos: false }), "nenhum acesso liberado");
