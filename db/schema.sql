...
create table if not exists manut_planos (
  ...
  visitas_extras_inclusas integer not null default 0,
  emergenciais_inclusos integer not null default 0,
...
create table if not exists manut_clientes (
  ...
  extras_contratados integer not null default 0,
  emergenciais_contratados integer not null default 0,
  extras_disponiveis integer not null default 0,
  emergenciais_disponiveis integer not null default 0,
...
insert into manut_contrato (id, texto) values (1, '') on conflict (id) do nothing;
...
alter table manut_leads enable row level security;
alter table manut_cupons enable row level security;
alter table manut_contrato enable row level security;
